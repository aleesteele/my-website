    ...
    render() {
        ...
        return (
            <div className="Home">
                ...
                <h1 className="Home-main-text">
                  In the meantime, take a look at my <a href="https://res.cloudinary.com/aleesteele/image/upload/v1620909383/Steele_CV_2021.pdf" className="Home-link link anim-middleout">CV</a>, <a href="http://notes.aleesteele.com" className="Home-link link anim-middleout">notes</a> or social media to learn more about me. And of course, feel free to <a href="mailto:aleesteele@gmail.com" className="Home-link link anim-middleout">get in touch. ✉</a>
                </h1><br/>
